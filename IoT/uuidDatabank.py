...
class DataBank:
    def __init__(self):
        ...
        self.databank = {
            ...
            "d519e1d9ed6f45a1a052b39fc31683e1": {"floor": 2, "room": "C", "previous_room": "A", "voice_message": "Great, we made it to our next waypoint. On the right you can see the university's library, If you want to borrow a book, please contact the front desk right after the entry.", "bridge_voice_message": "Your next waypoint is room C, the library!"},
            # Destination beacons
